...
/**
 * Estratégia que sempre joga a peça de maior valor que encaixa.
 * Se houver múltiplas peças que encaixam, escolhe a que tem a maior soma.
...
public class JogaMaiorPeca implements EstrategiaDeJogo {
    ...
    public Jogada decideJogada(VisaoDaMesa mesa, List<Peca> mao) {
        ...
        // Procura a peça com maior soma que encaixa
        for (Peca peca : mao) {
